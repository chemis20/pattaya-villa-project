    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-4">
          <h3 className="text-lg font-semibold text-gray-900">{t('villa_characteristics')}</h3>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="font-medium">115 {t('sqm')}</p>
              </div>
            </div>
        ...
        <Card className="bg-gradient-to-br from-purple-50 to-white border-purple-100">
          <CardContent className="p-6">
            <div className="flex flex-col items-center text-center space-y-4">
              <h3 className="text-xl font-bold text-gray-900">{t('unique_offer')}</h3>
              ...
              <div className="space-y-4 w-full">
                ...
                <div className="flex items-center justify-between text-sm">
                  <span className="text-gray-600">{t('investment_income')}</span>
                  <span className="font-medium text-green-600">{t('guaranteed_7')}</span>
                </div>
