      ...
      case "ru":
        return (
          <>
            ...
            <MapLink>престижном районе Хуай Яй в Паттайе</MapLink>. Вилла
      ...
      case "en":
        return (
          <>
            ...
            <MapLink>prestigious Huai Yai area in Pattaya</MapLink>. The villa
            includes 2 bedrooms, 3 bathrooms, connected kitchen with a hall, and
            a pool behind or in front of the house (there are 2 types of
            layouts).
          </>
        );
      case "zh":
        return (
          <>
            芭堤雅淮耶区<MapLink>高级区域的现代双层别墅</MapLink>
            ，面积150-156平方米。
